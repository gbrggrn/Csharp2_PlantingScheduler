...
namespace Csharp2_PlantingScheduler.Model.Plants.TypesOfPlants.Vegetable
{
    public static class VegetableDataMap
    {
        public static readonly Dictionary<Enums.VegetableType, VegetableMetaData> MetaData = new()
        {
            ...
            { Enums.VegetableType.Tomato, new VegetableMetaData {BaseStartWeek = 9, WeeksToHarvest = 16, IndoorWeeks = 8} },
            { Enums.VegetableType.Cucumber, new VegetableMetaData {BaseStartWeek = 15, WeeksToHarvest = 10, IndoorWeeks = 4 } },
            { Enums.VegetableType.Cabbage, new VegetableMetaData {BaseStartWeek = 13, WeeksToHarvest = 14 } },
            { Enums.VegetableType.Aubergine, new VegetableMetaData {BaseStartWeek = 8, WeeksToHarvest = 18, IndoorWeeks = 9} },
            ...
            { Enums.VegetableType.Onion, new VegetableMetaData {BaseStartWeek = 5 , WeeksToHarvest = 18, IndoorWeeks = 9} },
            { Enums.VegetableType.Pea, new VegetableMetaData {BaseStartWeek = 15, WeeksToHarvest = 9 } },
            { Enums.VegetableType.Pepper, new VegetableMetaData {BaseStartWeek = 5, WeeksToHarvest = 18, IndoorWeeks = 9} },
